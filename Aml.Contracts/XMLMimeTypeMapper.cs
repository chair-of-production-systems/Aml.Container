...
namespace Aml.Contracts
{
	...
	/// </summary>
	public static class XMLMimeTypeMapper
	{
		/// <summary> 
		...
		private static readonly IDictionary<string, string> Mappings = new Dictionary<string, string>(StringComparer.InvariantCultureIgnoreCase)
			{
				...
				{".aml", "model/vnd.automationml+xml"},
				...
				{".scomp", "application/smartcomponent"},
				{".sct", "text/scriptlet"},
				{".sd2", "audio/x-sd2"},
				{".sdp", "application/sdp"},
				...
				{".sproj", "application/smartproject"},
		...
		/// </summary>
		/// <param name="fileName">The file extension (may optionally start with a '.' character).</param>
		/// <returns>
		/// The according mime type or a default value ('application/octet-stream')
		/// </returns>
		/// <exception cref="System.ArgumentNullException">if the specified filename is null or empty.</exception>
		...
		/// <summary>
		/// Gets the content type of the specified Uri. Uses <see cref="GetMimeType(string)"/> internally.
		/// </summary>
		...
		/// <param name="uri">The uri.</param>
		/// <returns>The mime type.</returns>
		public static ContentType GetContentType(Uri uri)
		{
			if (uri == null) throw new ArgumentNullException(nameof(uri));
